...
const Project = ({ name, image, url, source, imageurl }) => {
  ...
  return (
      <div
        ...
        <div className="project-imgDiv d-flex justify-content-center align-items-center" onMouseOver={()=>setShowBtn(false)} onMouseOut={()=>setShowBtn(true)}>
          {/* <img src={`/images/${image}`} alt={name} className="rounded-3"/> */}
          <img src={imageurl ? imageurl : `/images/${image}`} alt={name} className="rounded-3"/>
